 // Game state
        ...
        function updateUI(playerChoice, computerChoice, result) {
            ...
            resultElement.textContent = result === 'tie' ? "It's a tie!" : 
            ...
            resultElement.style.backgroundColor = result === 'tie' ? '#ffeb3b' : 
                                                result === 'player' ? '#4CAF50' : '#f44336';
        }
